...
public class ViewRemoveTeacher extends JFrame{
  ...
  private void initializeComponents(){
    ...
    title = new JLabel("Remover Professor");
  ...
  public void buttonRemoveAction(){
    ...
    try{
      database.removeTeacher(textSurchRegisterAction());
    }catch(NullPointerException e){
      JOptionPane.showMessageDialog(null, "Usuário nã encontrado!");
